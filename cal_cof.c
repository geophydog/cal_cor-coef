...
int main(int argc, char *argv[]) {
    int i;
    float *data1, *data2, x_sigma = 0., y_sigma = 0., x_sqa = 0., y_sqa = 0., x_y = 0., cof;
    SACHEAD hd1, hd2;
    ...
    cof = (hd1.npts*x_y-x_sigma*y_sigma)/sqrt((hd1.npts*x_sqa-x_sigma*x_sigma)*(hd1.npts*y_sqa-y_sigma*y_sigma));
